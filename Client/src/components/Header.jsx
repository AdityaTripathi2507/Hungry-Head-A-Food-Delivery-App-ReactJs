...
import { Logo, avatar } from "../assests";
  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20 py-6">
      <NavLink to={"/"} className="flex items-center justify-center gap-4">
        ...
        <p className="font-semibold text-xl">Hungry-Head</p>
      </NavLink>
      ...
      <nav className="flex items-center justify-center gap-8">
        ...
        <motion.div {...buttonClick} className="relative cursor-pointer">
          ...
          <div className="w-5 h-5 rounded-full bg-red-500 flex items-center justify-center absolute -top-4 -right-1">
        ...
        {user ? (
          ...
          <>
            <NavLink to={"/login"}>
              <motion.button
                {...buttonClick}
                className="px-4 py-2 rounded-md shadow-md bg-LightOverlay border border-red-300 cursor-pointer hover:bg-red-500"
              >
                Login
              </motion.button>
            </NavLink>
